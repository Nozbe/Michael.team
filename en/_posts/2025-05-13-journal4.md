...
This Shortcut is completely free and you can download it here:
...
## How Journal 4 works step by step?
...
### Evening Journal - the main journal!
...
### Add something to Journal - during the day…
...
### Photos of the day - optional photo memory
...
Again, an optional thing. When you want to (and I do!), you can re-connect with your goals each time you're writing your Journal. To do that, just set your goals according to my template or whatever you feel like. Once your goals are saved, each time you either do the Morning or Evening journaling, you'll be reminded of the goals first, before you write anything down. Many people swear by it, that repeating, re-reading and re-connecting with your goals regularly helps you stay focused.
...
### Last menu option - version history and updates!

The last menu option is the version of the Shortcut. I've made screenshots with the version `4.36` and I'll be improving the Shortcut as I go. When you click on this option, the Shortcut will check online on my blog if there is a new version and prompt you to visit this post and [download the latest version][j].
...
What's even cooler is that the Shortcut has built-in auto-save, so if you start journaling and save a few answers but then
...
I've been iterating on this Shortcut for weeks. I'm releasing the version 3.8 to the world. If you're curious how I got there, here are the most important milestones as I was re-writing it from scratch from [version 3](/journal3):
...
As I keep improving the Shortcut I might post new versions here.

## Happy Journaling!

I hope you'll find my brand [new Journal 4 Shortcut][j] useful and again, I challenge you to start journaling and let me know on social media how it's going for you!
